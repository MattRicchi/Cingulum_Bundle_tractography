...
def run_t_test(df1, df2, measure, tract, group1_name, group2_name):
    # print(df1)
    # print(df2)
    group1_data = np.array(df1[(df1['measure'] == measure) & (df1['tract'] == tract) & (df1['mean'] != 0.0)]['mean'])
    group2_data = np.array(df2[(df2['measure'] == measure) & (df2['tract'] == tract) & (df2['mean'] != 0.0)]['mean'])
...
for measure in measures:
    ...
    #             run_t_test(group1_df, group2_df, measure, tract, group1_name, group2_name),
    #             ignore_index=True)
    ...
    results_df.to_excel(f'/mnt/c/Users/ricch/OneDrive - University of Pisa/Cingulum_bundle_study/DATABASE/{measure}_Ttest_TRACTS.xlsx', index=False)